...
def depthFirstSearch(problem):
    ...
    while(not frontier.isEmpty()):
        ...
        if(state not in expanded):
            ...
            for childState,childAction,stepCost in childsOfState: #το stepCost δεν χρειαζεται στον αλγόριθμο
                frontier.push(childState) #αποθηκεύουμε μόνο το state στο stack
...
def breadthFirstSearch(problem):
    ...
    while(not frontier.isEmpty()):
        ...
        if(state not in expanded):
            ...
            for childState,childAction,stepCost in childsOfState: #το stepCost δεν χρειαζεται στον αλγόριθμο
                frontier.push(childState) #αποθηκεύουμε μόνο το state στο queue
